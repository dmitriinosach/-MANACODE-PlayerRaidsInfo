...
Откуда данные: рейды — из логов WoW Circle, рейтинг игроков и парсы — с сайта [Боберлогс](https://boberlogs.top). То же написано в окне `/raids`, кнопка «Откуда данные» внизу.
